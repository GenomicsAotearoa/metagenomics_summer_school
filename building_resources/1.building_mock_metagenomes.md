...
The genomes chosen in the [Introduction notebook](https://github.com/GenomicsAotearoa/metagenomics_summer_school/building_resources/0.introduction.md) were simply pulled from the NCBI repository using *wget*.
