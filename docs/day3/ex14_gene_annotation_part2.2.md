# Bin coverage 2: Read mapping and coverage calculation

## NOTE (KH 2026-08-31):

Note to update coverage calculation method from jgi_summarize_bam_contig_depths, and add normalisation to this.
